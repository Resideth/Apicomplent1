...
public class PostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post); // CORRECCIÓN AQUÍ: Usar el layout correcto
        ...
        buttonSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (title.isEmpty() || body.isEmpty()) {
                    Toast.makeText(PostActivity.this, "Por favor, complete todos los campos", Toast.LENGTH_SHORT).show(); // CORRECCIÓN AQUÍ
                } else {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Toast.makeText(PostActivity.this, "Post creado con ID: " + id, Toast.LENGTH_LONG).show(); // CORRECCIÓN AQUÍ
                            ...
                            e.printStackTrace();
                            Toast.makeText(PostActivity.this, "Error al parsear la respuesta JSON: " + e.getMessage(), Toast.LENGTH_LONG).show(); // CORRECCIÓN AQUÍ
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(PostActivity.this, "Error al crear post: " + error.getMessage(), Toast.LENGTH_LONG).show(); // CORRECCIÓN AQUÍ
